...
//-----------------------------------中金所-----------------------------------------------
#define ID_CFFEX_BASEINFO 3001	 //期货及期权基础信息
#define ID_CFFEX_MARKETDATA 3002   //期货及期权行情数据
#define ID_CFFEX_FORQOUTE 3003	 //询价通知
#define ID_CFFEX_MARKETDATAL2 3004 //期货及期权L2行情数据
#define ID_CFFEX_KLINE 3007 //期货及期权分钟K线行情数据
