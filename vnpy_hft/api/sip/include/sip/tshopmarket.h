...
//-----------------------------------上交所期权-------------------------------------------
#define ID_SHOP_BASEINFO 8001   //期权基础信息 对应T_SH_OptionBaseInfo
#define ID_SHOP_MARKETDATA 8002 //期权市场代码 对应T_SH_OptionMarketData
...
typedef struct t_SHOP_MarketData
{
	...
	T_I64 iDailyPriceUpLimit;	  //	涨幅上限价格	N11(4)	当日期权涨停价格，单位：元（精确到0.1厘）
	T_I64 iDailyPriceDownLimit;	//	跌幅下限价格	N11(4)	当日期权跌停价格，单位：元（精确到0.1厘）
